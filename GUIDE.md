...
* [Macaw's Lights and Lamps](https://www.curseforge.com/minecraft/mc-mods/macaws-lights-and-lamps) - Have you ever wanted to have other light sources than torches, glowstones or redstone lamps? If that's the case, then you are at the right place!
* [Macaw's Paintings](https://www.curseforge.com/minecraft/mc-mods/macaws-paintings) - This version adds 46 paintings, with a vanila fitting style. If you have any suggestions for some painting we could make, let us know!
* [Macaw's Trapdoors](https://www.curseforge.com/minecraft/mc-mods/macaws-trapdoors) - Have you ever thought, how great would it be when Minecraft had the basic vanila trapdoors in each plank variation? If so then you have come to the right place! Macaw's Trapdoor adds vanila trapdoors in every plank variation.
